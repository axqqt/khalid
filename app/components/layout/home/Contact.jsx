...
export default function DetailedPropertyInquiryForm() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-b from-black/50 to-black/50 mix-blend-multiply"
        style={{ backgroundColor: "rgba(218, 165, 32, 0.1)" }}
      ></div>

      {/* Rest of the form content remains the same */}
      <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-8 sm:p-10 border border-amber-500">
        {/* Form Header */}
